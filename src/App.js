...
// https://geo.ipify.org/api/v2/country?apiKey=at_ZzYtUYI9bUwKhiwCVvGNpPxIzVE6h&ipAddress=8.8.8.8
...
function App() {
  ...
  return (
    <>
      <section>
        <div>
          <img src={background} alt="" className="w-full h-80 object-cover absolute -z-10"/>
        </div>
        <article className="p-8">
          <h1 className="text-2xl text-center text-white
          font-bold mb-8 lg:text-3xl">IP Address Tracker</h1>
        ...
        {address && <>
          <article className="bg-white rounded-lg p-8 mx-8 grid grid-cols-1 
              gap-8 md:grid-cols-2 lg:grid-cols-4 max-w-6xl xl:mx-auto text-center md:text-left lg:-mb-16 relative" style={{zIndex: 10000}}>
